...
public class PinkDiamondCrosswordGAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PinkDiamondCrosswordGAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordGAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordGAIW/InitOutcome.xml").getDocumentElement();
